...
const Header = () => {
  ...
  return (
    <div style={{position : 'fixed', top: 0, zIndex : '2'}} className={classes.headerWrap}>
      ...
      <div className={classes.myMenuArea}>
        ...
        <div className={classes.myMenuItem}>
          <svg viewBox="0 0 28 28" alt="" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x198g3q0" fill="currentColor"
               height="20" width="20">
            <path
        ...
        <div onClick={() => {link('/myinfo')}} className={classes.myMenuItem}>
